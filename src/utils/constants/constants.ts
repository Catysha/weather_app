...
export const cities = [
    { value: 'Minsk', label: 'Минск', country: 'BY' },
    { value: 'Kobrin', label: 'Кобрин', country: 'BY' },
    { value: 'Brest', label: 'Брест', country: 'BY' },
    { value: 'Grodno', label: 'Гродно', country: 'BY' },
    { value: 'Vitebsk', label: 'Витебск', country: 'BY' },
    { value: 'Mogilev', label: 'Могилёв', country: 'BY' },
    { value: 'Gomel', label: 'Гомель', country: 'BY' },
    { value: 'Pinsk', label: 'Пинск', country: 'BY' },
    { value: 'Moscow', label: 'Москва', country: 'RU' },
    { value: 'Saint Petersburg', label: 'Санкт-Петербург', country: 'RU' },
    { value: 'Paris', label: 'Париж', country: 'FR' },
    { value: 'London', label: 'Лондон', country: 'GB' },
    { value: 'Berlin', label: 'Берлин', country: 'DE' },
    { value: 'New York', label: 'Нью-Йорк', country: 'US' },
    { value: 'Tokyo', label: 'Токио', country: 'JP' },
    { value: 'Sydney', label: 'Сидней', country: 'AU' },
];